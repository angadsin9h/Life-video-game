...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/weekly-power',            icon: TrendingUp,     label: 'Weekly Power Session' },
      ...
      { to: '/mind-body-balance',       icon: Activity,       label: 'Mind-Body Balance'    },
      { to: '/emotional-dashboard',     icon: Heart,          label: 'Emotional Dashboard'  },
      { to: '/strategic-life-plan',     icon: Target,         label: 'Strategic Life Plan'  },
      { to: '/habit-matrix',            icon: Layers,         label: 'Habit Matrix'         },
      { to: '/life-checkup',            icon: Award,          label: 'Life Checkup'         },
      { to: '/flow-state-tracker',      icon: Zap,            label: 'Flow State Tracker'   },
      { to: '/mindfulness-center',      icon: Wind,           label: 'Mindfulness Center'   },
      { to: '/wealth-builder',          icon: TrendingUp,     label: 'Wealth Builder'       },
      { to: '/relationship-tracker',    icon: Users,          label: 'Relationship Tracker' },
      { to: '/creative-studio',         icon: Sparkles,       label: 'Creative Studio'      },
      { to: '/deep-work-log',           icon: Brain,          label: 'Deep Work Log'        },
      { to: '/growth-journal',          icon: BookOpen,       label: 'Growth Journal'       },
      { to: '/life-energy',             icon: Zap,            label: 'Life Energy'          },
      { to: '/identity-architect',      icon: Star,           label: 'Identity Architect'   },
      { to: '/value-alignment-log',     icon: Heart,          label: 'Value Alignment'      },
      { to: '/win-board',               icon: Trophy,         label: 'Win Board'            },
      { to: '/reflection-engine',       icon: BookOpen,       label: 'Reflection Engine'    },
      { to: '/life-rating',             icon: BarChart3,      label: 'Life Rating'          },
      { to: '/life-metrics-hub',        icon: Activity,       label: 'Life Metrics Hub'     },
      { to: '/morning-powerup',         icon: Sun,            label: 'Morning Powerup'      },
      { to: '/evening-winddown',        icon: Moon,           label: 'Evening Winddown'     },
      { to: '/goal-crusher',            icon: Target,         label: 'Goal Crusher'         },
      { to: '/habit-evolution',         icon: TrendingUp,     label: 'Habit Evolution'      },
      { to: '/spiritual-log',           icon: Sparkles,       label: 'Spiritual Log'        },
      { to: '/obstacle-destroyer',      icon: Shield,         label: 'Obstacle Destroyer'   },
      { to: '/focus-protocol',          icon: Timer,          label: 'Focus Protocol'       },
      { to: '/body-optimizer',          icon: Activity,       label: 'Body Optimizer'       },
      ...
      { to: '/clarity-session',         icon: Eye,            label: 'Clarity Session'      },
      { to: '/peak-moment-log',         icon: Star,           label: 'Peak Moment Log'      },
      { to: '/challenge-acceptor',      icon: Flag,           label: 'Challenge Acceptor'   },
      ...
      { to: '/thought-audit',           icon: Brain,          label: 'Thought Audit'        },
      { to: '/energy-rituals',          icon: Zap,            label: 'Energy Rituals'       },
      { to: '/momentum-tracker',        icon: TrendingUp,     label: 'Momentum Tracker'     },
      { to: '/fear-inventory-log',      icon: Shield,         label: 'Fear Inventory Log'   },
      { to: '/mind-reset',              icon: RefreshCw,      label: 'Mind Reset'           },
      { to: '/vitality-rituals',        icon: Flame,          label: 'Vitality Rituals'     },
      ...
      { to: '/sleep-protocol',         icon: Moon,           label: 'Sleep Protocol'       },
      { to: '/quantified-self',        icon: Activity,       label: 'Quantified Self'      },
      { to: '/personal-mission',       icon: Compass,        label: 'Personal Mission'     },
      { to: '/annual-planning',        icon: Flag,           label: 'Annual Planning'      },
      { to: '/life-alignment',         icon: Target,         label: 'Life Alignment'       },
      { to: '/momentum-dashboard',     icon: Zap,            label: 'Momentum Dashboard'   },
      { to: '/future-self-letter',     icon: Feather,        label: 'Future Self Letter'   },
      { to: '/relationship-health',    icon: Heart,          label: 'Relationship Health'  },
      { to: '/habit-design-lab',       icon: FlaskConical,   label: 'Habit Design Lab'     },
      { to: '/personal-economy',       icon: PiggyBank,      label: 'Personal Economy'     },
      { to: '/evening-ritual',         icon: Moon,           label: 'Evening Ritual'       },
      { to: '/mental-model-lab',       icon: Brain,          label: 'Mental Model Lab'     },
      { to: '/body-reset',             icon: Heart,          label: 'Body Reset'           },
      { to: '/life-vision-board',      icon: Star,           label: 'Life Vision Board'    },
      { to: '/daily-wins',             icon: Award,          label: 'Daily Wins'           },
      { to: '/morning-gratitude',      icon: Sun,            label: 'Morning Gratitude'    },
      { to: '/life-scorecard',         icon: BarChart3,      label: 'Life Scorecard'       },
      { to: '/weekly-retro',           icon: RefreshCw,      label: 'Weekly Retro'         },
      { to: '/idea-vault',             icon: Lightbulb,      label: 'Idea Vault'           },
      ...
      { to: '/sleep-quality',          icon: Moon,           label: 'Sleep Quality'        },
      { to: '/concentration',          icon: Brain,          label: 'Concentration'        },
      { to: '/daily-highlights',       icon: Star,           label: 'Daily Highlights'     },
      { to: '/anticipation',           icon: Sun,            label: 'Anticipation Journal' },
      { to: '/digital-habits',         icon: Smartphone,     label: 'Digital Habits'       },
      ...
      { to: '/gratitude-letters',      icon: Heart,          label: 'Gratitude Letters'    },
      { to: '/life-purpose-log',       icon: Sparkles,       label: 'Life Purpose Log'     },
      { to: '/relationship-checkin',   icon: Users,          label: 'Relationship Check-In'},
      { to: '/creative-sprint',        icon: Zap,            label: 'Creative Sprint'      },
      { to: '/habit-reflection',       icon: RefreshCw,      label: 'Habit Reflection'     },
